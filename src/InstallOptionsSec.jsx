    ...
    return (
        <div className="bg-white  justify-self-center">
            ...
            <div className="flex mt-12 gap-x-12 m-auto">
                <div className="grid grid-rows-3 gap-y-4 p-4 border border-gray-200 shadow-lg w-fit rounded-2xl">
                    ...
                    <div className="flex justify-between bg-blue-100 h-12 w-90 items-center rounded-xl px-4">
                ...
                <div className="grid grid-rows-3 gap-y-4 p-4 border border-gray-200 shadow-lg w-fit rounded-2xl">
                    ...
                    <div className="flex justify-between bg-blue-100 h-12 w-90 items-center rounded-xl px-4">
                        <div className="flex gap-2 font-mono text-[14px]">
                            <p>{"<>"}</p>
