...
const DevEx = () => {
    return (
        <div className='bg-gray-100 py-18 my-16 border-t border-gray-300'>
            <div className='max-w-6xl m-auto flex justify-between max-md:text-start max-md:mx-4'>
                <div>
                    <p className='font-sans text-blue-900 font-semibold my-2'>DEVELOPER EXPERIENCE</p>
                    <p className='font-extrabold text-5xl max-md:text-[32px]'>Write code humans can <br /> understand</p>
                    <p className='my-4 text-gray-600 max-md:text-[14px]'>Cascade.js replaces cryptic regex strings with named, descriptive functions. <br /> It's self documenting validation that makes your codebase cleaner and <br /> easier to maintain</p>
                    <div className='grid gap-3'>
                        <div className='flex items-start gap-2'>
                            ...
                            <div>
                                ...
                                <p className='text-gray-500 text-[14px] max-md:text-[12px]'>Import and start validating immediately. No setup files.</p>
                            </div>
                        </div>
                        <div className='flex items-start gap-2'>
                            <div className='text-green-700 bg-green-200 p-1 w-fit h-fit rounded-full'>
