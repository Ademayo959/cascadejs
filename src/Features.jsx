    ...
    return (
        <div className="bg-white max-w-6xl m-auto">
            <div className="my-4">
                ...
                <div className="grid grid-cols-3 my-12 max-md:grid-cols-1 max-md:gap-y-10 max-md:justify-self-center">
                    <div className="w-90 p-4 border rounded-xl shadow-xl border-gray-200 max-md:w-80">
