            ...
            <div className="max-w-6xl m-auto justify-self-center">
                ...
                <div className="justify-self-center py-4">
                    <a href="https://github.com/Ademayo959/cascadejs">
                        <div className='h-fit w-fit p-2 hover:scale-110 transition-all border bg-[#1d3989] text-white border-gray-400 shadow-md flex gap-1 rounded-4xl items-center justify-center'>
